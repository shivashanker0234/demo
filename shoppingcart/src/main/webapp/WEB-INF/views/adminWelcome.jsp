...
<nav class="navbar navbar-light bg-primary justify-content-between">
  ...
  <form class="form-inline">
    <p class="mr-4" style="color: #FFFFFF"><b>${id}</b></p>
...
<form action="fetc" method="post">
  <div class="center">
    ...
    <button type="button">
      <a style="color: #17a2b8" href="${pageContext.request.contextPath}/product.jsp">Home</a></button>
    <button type="button">
      <a style="color: #17a2b8" href="${pageContext.request.contextPath}/fetchAdminProducts">My Products</a></button>
    <br><br>
