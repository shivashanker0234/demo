...
<nav class="navbar navbar-light bg-primary justify-content-between">
    ...
    <form class="form-inline">
        ...
        <button class="btn btn-outline-success my-2 my-sm-0" style="color: white" type="submit">
            <a style="color: #FFFFFF" href="getAllProductsByName/${name}">Search </a>
        ...
        <button class="btn btn-outline-success my-2 my-sm-0">
            <a style="color:white" type="submit" href="${pageContext.request.contextPath}/fetchOrders">My Orders</a>
        </button>

    </form>
</nav>
<p>${welcomeMessage}</p>
<jsp:useBean id="listProduct" class="java.lang.String" scope="application"/>
