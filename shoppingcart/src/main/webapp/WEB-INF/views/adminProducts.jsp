        ...
        <div href="productDetails" class="box card">
          ...
          <div class="info">
            ...
            <button class="btn btn-primary">
              <a style="color: red "
                 href="${pageContext.request.contextPath}/deleteProduct/${item.productId}">Delete Product </a>
            </button>
<%--            <button class="btn btn-primary">--%>
<%--              <a style="color: #FFFFFF "--%>
<%--                 href="${pageContext.request.contextPath}/adminProductDetails/${item.productId}">Details</a>--%>
<%--            </button>--%>
          </div>
        </div>
      </div>
